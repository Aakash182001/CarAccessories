...
public class CarAccessories extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        mainFormPanel.setBackground(javax.swing.UIManager.getDefaults().getColor("Actions.GreyInline"));
        mainFormPanel.setForeground(new java.awt.Color(2, 0, 0));
        ...
        detailsPanel.setForeground(new java.awt.Color(204, 204, 255));
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Accessories ID", "Accessories Name", "Category", "Price", "Price Range", "Recommendation"
            }
        ) {
            ...
            .addGroup(detailsPanelLayout.createSequentialGroup()
                ...
                .addGroup(detailsPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(detailsPanelLayout.createSequentialGroup()
                        ...
                        .addComponent(priceSrch, javax.swing.GroupLayout.PREFERRED_SIZE, 146, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(priceSrchbtn)
                        .addGap(21, 21, 21))
                    .addGroup(detailsPanelLayout.createSequentialGroup()
        ...
        getContentPane().add(titlePanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, 1440, 50));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CarAccessories.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CarAccessories().setVisible(true);
